import { CANONICAL_WORKSPACE_KEY, resolveLaunchTarget } from "./navigationContract.js";

export const SHELL_ACTION_KEY = Object.freeze({
...
export const SHELL_ACTION_CATALOG = Object.freeze({
...
export const LAUNCH_SURFACE_SHELL_ACTION_KEY = Object.freeze({
...
export const BOT_HANDLER_SHELL_ACTION_KEY = Object.freeze({
...
export function normalizeShellActionKey(value) {
  return String(value || "").trim().toLowerCase();
}

export function resolveShellActionTarget(actionKey) {
...
export function resolveShellActionKeyForBotHandler(handlerKey) {
  const key = normalizeShellActionKey(handlerKey);
  return BOT_HANDLER_SHELL_ACTION_KEY[key] || "";
}

export function resolveShellActionKeyForLaunchSurface(surfaceKey) {
