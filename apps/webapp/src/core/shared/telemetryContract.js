...
export const UI_SURFACE_KEY = Object.freeze({
  ...
  PANEL_ADMIN_LIVE_OPS: CANONICAL_PANEL_KEY.PANEL_ADMIN_LIVE_OPS
});
...
export function buildAnalyticsEventKey(family, object, verb) {
  return normalizeAnalyticsKey([family, object, verb].join("."), "");
}

export function normalizeAnalyticsKey(value, fallback = "", maxLen = 80) {
...
export function isSafeAnalyticsKey(value, maxLen = 80) {
...
export function normalizeTelemetryDimension(value, fallback = "", maxLen = 80) {
  return normalizeNavigationKey(value, fallback, maxLen);
}

export function normalizeTxState(value) {
...
export function normalizeUiEvent(rawEvent, defaults = {}) {
...
export function normalizeUiEventBatch(rawEvents, defaults = {}) {
